                    ...
                    <nav className="space-y-2">
                        <Link
                            ...
                            className={`flex items-center gap-3 text-white hover:bg-purple-700 px-4 py-2 rounded-md ${
                                location.pathname === '/admin' ? 'bg-purple-700' : ''
                            }`}
                        >
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-3 text-white hover:bg-purple-700 px-4 py-2 rounded-md ${
                                location.pathname === '/admin/products/new' ? 'bg-purple-700' : ''
                            }`}
                        >
                        ...
                        <Link
                            to="/admin/orders"
                            className={`flex items-center gap-3 text-white hover:bg-purple-700 px-4 py-2 rounded-md ${
                                location.pathname.startsWith('/admin/orders') ? 'bg-purple-700' : ''
                            }`}
                        >
                        ...
                        <Link
                            to="/admin/content"
                            className={`flex items-center gap-3 text-white hover:bg-purple-700 px-4 py-2 rounded-md ${
                                location.pathname === '/admin/content' ? 'bg-purple-700' : ''
                            }`}
                        >
